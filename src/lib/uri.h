...
enum uri_error {
	...
	URI_E_CA_FAIL, // Getting configured CAs failed (see uri_sub_errno)
...
// Error that is set when uri_errno is set to either one of these:
//   URI_E_CA_FAIL
//   URI_E_CRL_FAIL
//   URI_E_PUBKEY_FAIL
//   URI_E_SIG_FAIL
...
// This might be NULL if uri_sub_errno was generated by URI object inicialization
// or if error was not generated by sub URI directly.
